...
# Ecological forecasting is not necesarily an initial condition problem 
B) Using the existing model and Monte Carlo approach, describe how you might partition the contribution of each parameter (r, Kg, alpha, beta) to the forecast uncertainty. # hold mean parameter for all parameters except the one you're trying to see uncertainty contribution 
...
# yes because the driver uncertainty increases 
...
# understand site-to-site variability; 
